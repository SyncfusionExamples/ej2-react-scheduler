    ...
    return (
      <div className="control-section">
        ...
        <div className="schedule-control">
          <ScheduleComponent id="schedule" ref={(schedule: ScheduleComponent) => this.scheduleObj = schedule} height="550px" selectedDate={new Date(2017, 5, 5)} currentView="Month" readonly={true}
